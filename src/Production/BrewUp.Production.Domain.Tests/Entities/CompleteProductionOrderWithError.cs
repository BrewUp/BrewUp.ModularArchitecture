...
public sealed class CompleteProductionOrderWithError : CommandSpecification<CompleteProductionOrder>
{
    ...
    public CompleteProductionOrderWithError()
    {
    ...
    {
        yield return new ProductionOrderAlreadyCompleted(_productionOrderId);
    }
}