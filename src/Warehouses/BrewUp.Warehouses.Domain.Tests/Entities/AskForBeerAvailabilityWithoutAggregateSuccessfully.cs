...
public sealed class AskForBeerAvailabilityWithoutAggregateSuccessfully : CommandSpecification<AskForBeerAvailability>
{
    private readonly Guid _correlationId = Guid.NewGuid();
    
    private readonly BeerId _beerId = new(Guid.NewGuid());
    private readonly BeerName _beerName = new ("Muflone IPA");
    private readonly Availability _availability = new (0, "Lt");
